...
class CredentialSetsController < ApplicationController
  ...
  def create
    ...
    if @credential_set.save
      redirect_to [:edit, @credential_set.exercise, @credential_set], notice: 'Credential was successfully created.'
    else
  ...
  def update
    if @credential_set.update credential_set_params
      redirect_to [:edit, @credential_set.exercise, @credential_set], notice: 'Credential was successfully updated.'
    else
  ...
  def destroy
    if @credential_set.destroy
      redirect_to [@exercise, :credential_set], notice: 'Credential was successfully destroyed.'
    else
